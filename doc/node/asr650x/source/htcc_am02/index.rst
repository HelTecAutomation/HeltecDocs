...
Instruction
===========
`HTCC-AM02 V2 <https://heltec.org/project/htcc-am02/>`_ is a part of the “CubeCell“ series, with the following features:
...
.. toctree::
   ...
   Reference Circuit Design (Arduino) <https://resource.heltec.cn/download/CubeCell/HTCC-AM02_Module/HTCC-AM02_Reference_Design(Arduino).pdf>
   Reference Circuit Design (AT) <https://resource.heltec.cn/download/CubeCell/HTCC-AM02_Module/HTCC-AM02_Reference_Design(AT).pdf>
